            ...
            if (!isMap) {
                ...
                geocoder.addressSearch(address, function(result, status) {
                    if (status === kakao.maps.services.Status.OK) {
                        ...
                        setValue === null || setValue === void 0 ? void 0 : setValue("boardAddressInput.lat", Number(newSearch.y));
                        setValue === null || setValue === void 0 ? void 0 : setValue("boardAddressInput.lng", Number(newSearch.x));
                    }
                });
            }
        });
